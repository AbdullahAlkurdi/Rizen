  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HomeCubit, HomeState>(
      builder: (context, state) {
        ...
        final sleepPattern = state is HomeLoaded
            ? state.sleepWeekPattern
            : <double>[];
        ...
        final analysisNotes =
            todaySleep?.analysisNotes ?? 'No sleep log recorded yet.';
            ...
            children: [
                        ...
                        Expanded(
                          child: _WakeStat(
                            ...
                            value: targetWake != null
                                ? '${targetWake.hour}:${targetWake.minute.toString().padLeft(2, '0')}'
                                : '--:--',
                        ...
                        Expanded(
                          child: _WakeStat(
                            ...
                            value: actualWake != null
                                ? '${actualWake.hour}:${actualWake.minute.toString().padLeft(2, '0')}'
                                : '--:--',
                    ...
                    if (todaySleep != null && todaySleep.confirmed != true)
                      Padding(
                        ...
                        child: FilledButton.icon(
                          onPressed: () {
                            context.read<HomeCubit>().confirmSleepLog(
                              todaySleep.id,
                              true,
                            );
                          },
              ...
              GlassCard(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Bed Resistance Metric: ${(bedResistance * 100).round()}',
                ...
                child: SizedBox(
                  ...
                  child: Row(
                    ...
                    children: List.generate(7, (index) {
                      final heightFactor = sleepPattern.length > index
                          ? sleepPattern[index]
                          : 0.0;
                      return Expanded(
                        child: Padding(
